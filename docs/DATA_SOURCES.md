...
| [nflverse](https://github.com/nflverse/nflverse-data) | 2026 schedule, roof, surface, rest, available spread/total snapshots; 2023-25 statistical and recorded-weather splits | CC BY 4.0 | Attribute; preserve sample counts; call lines market observations, not projections |
| [NASA POWER climatology](https://power.larc.nasa.gov/docs/services/api/temporal/climatology/) | 2001–2020 monthly venue temperature, precipitation, and wind normals | NASA open-data service; baseline is checked in with retrieval/source metadata | Always label as a climate normal, never a game forecast or precipitation probability |
| [NOAA Climate Prediction Center](https://www.cpc.ncep.noaa.gov/products/predictions/long_range/) | 6–10 day, 8–14 day, and week 3–4 categorical temperature/precipitation outlooks | US government outlook products; refreshed with the environment bundle | Preserve category, probability, valid dates, and issue date; never invent an exact temperature or rain amount |
...
Venue coordinates are a reviewed input used only to join a scheduled stadium to
climate/outlook/forecast data. Each scheduled game retains its venue ID and the
effective-dated override layer, so an international game or new stadium cannot
silently inherit the designated home team's environment.
...
- A market total/spread is an observed consensus snapshot embedded in nflverse,
  not live sportsbook execution data. The app does not contact a betting account,
  place wagers, or depend on a paid odds feed.
- NASA precipitation is a monthly average in millimeters per day, not the chance
  that a particular game will be wet. NOAA outlook precipitation is a category
  relative to normal; exact game precipitation appears only in an in-horizon
  NWS/MET forecast.
